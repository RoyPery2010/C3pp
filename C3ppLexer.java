...
public class C3ppLexer extends Lexer {
	...
	public static final int
		...
		IDENTIFIER=32, WS=33, LINE_COMMENT=34, BLOCK_COMMENT=35;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"LE", "GE", "NOT", "LPAREN", "RPAREN", "LBRACE", "RBRACE", "COMMA", "SEMI", 
			"INT_LITERAL", "FLOAT_LITERAL", "BOOL_LITERAL", "IDENTIFIER", "WS", "LINE_COMMENT", 
			"BLOCK_COMMENT"
		};
	}
	...
	public C3ppLexer(CharStream input) {
		super(input);
