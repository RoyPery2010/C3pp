...
public:
  enum {
    ...
    WS = 33, LINE_COMMENT = 34, BLOCK_COMMENT = 35, Identifier = 36
  };

  enum {
    RuleProgram = 0, RuleClassDeclaration = 1, RuleClassBody = 2, RuleConstructorDeclaration = 3, 
    RuleFieldDeclaration = 4, RuleMethodDeclaration = 5, RuleMethodBody = 6, 
    RuleFunctionDeclaration = 7, RuleVariableDeclaration = 8, RuleParameterList = 9, 
    RuleParameter = 10, RuleType = 11, RuleBlock = 12, RuleStatement = 13, 
    RuleExpressionStatement = 14, RuleReturnStatement = 15, RuleExpression = 16, 
    RuleAssignment = 17, RuleEquality = 18, RuleComparison = 19, RuleAddition = 20, 
    RuleMultiplication = 21, RuleUnary = 22, RulePrimary = 23
  };
